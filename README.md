...
The most important number in this chart is the 0.08 in the bottom right, where median income meets food insecurity. That is essentially zero — provinces that earn more do not systematically have less hunger. The strongest direct link to food insecurity is tenant shelter burden at 0.34. Provinces where more renters spend 30 percent or more of their income on housing tend to have more people going hungry. When rent takes most of your paycheque, there is less left for food.
